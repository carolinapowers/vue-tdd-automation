...
describe('createComponent', () => {
    ...
    describe('successful creation', () => {
        it('should execute create script with component name', async () => {
            ...
            expect(execSyncSpy).toHaveBeenCalledWith(expect.stringContaining('create-tdd-component.js'), expect.objectContaining({
                cwd: mockCwd,
                stdio: 'inherit'
            }));
        });
    ...
    describe('error handling', () => {
        it('should throw error if script execution fails', async () => {
            ...
            await expect(createComponent('MyButton')).rejects.toThrow("Failed to create component. Make sure you've run 'vue-tdd init' first.");
        });
